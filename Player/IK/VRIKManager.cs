...
namespace LCVR.Player.IK
{
    ...
    public class VRIKManager : MonoBehaviour
    {
        ...
        public void AutoDetectReferences()
        {
            ...
            {
                Logger.LogError("VRIK needs a Humanoid Animator to auto-detect biped references. Please assign references manually.");
                return;
            }

            Logger.LogDebug("Auto detecting references....");
